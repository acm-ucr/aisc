...
const RandD = () => {
  return (
    <div className="mx-20 my-10 flex flex-col items-center justify-center sm:mx-25 md:mx-30 lg:mx-35">
      ...
      <div className="grid grid-cols-1 justify-center gap-10 pt-10 sm:grid-cols-2">
        ...
        <div className="grid-row-2 grid">
          ...
          <Button
            asChild
            className="bg-aisc-blue h-9 w-35 justify-self-center rounded-4xl text-sm sm:text-base md:h-13 md:w-45 md:text-lg lg:text-xl"
          >
