  ...
  return (
    <div className="mx-auto my-20 flex w-1/2 flex-col items-center text-center">
      ...
      <p className="my-6 text-xl leading-6 text-balance">
        ...
        directions. Whether you're just curious about AI or building your own
        model from scratch, you'll find a supportive, inspiring community here.
        Join us and help shape the future of AI at UCR!
      </p>
    </div>
  );
};
